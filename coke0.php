...
echo '<h2>Coke Zero</h2>';
echo '<p>Coca Cola Zero Sugar is our sugar-free cola, that looks and tastes just like Coca Cola Original Taste, but without the sugar.</p>';
echo '</div>';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!frontViewBtn || !topViewBtn || !backViewBtn || !cameraImage || !wireframeBtn ) {
        return;
    }

    frontViewBtn.addEventListener('click', function() {
        cameraImage.src = "C0_FV.jpg";
        toggleImage();
    });

    topViewBtn.addEventListener('click', function() {
        cameraImage.src = "C0_TP.jpg";
        toggleImage();
    });

    backViewBtn.addEventListener('click', function() {
        cameraImage.src = "C0_BCK.jpg";
        toggleImage();
    });
