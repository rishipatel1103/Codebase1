...
echo '<h2>Dr Pepper</h2>';
echo '<p>A unique sparkling blend of 23 fruit flavours, Dr Pepper has that distinctive flavour you just can’t quite put your finger on, or can you? </p>';
echo '</div>';
...
echo '<p></p>';
echo '<button class="btn btn-primary" id="back-view-btn">Back View</button>';
echo '<p></p>';
echo '<button class="btn btn-primary" id="left-view-btn">Left View</button>';
echo '<p></p>';
echo '<button class="btn btn-primary" id="right-view-btn">Right View</button>';
echo '<p></p>';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var backViewBtn = document.getElementById('back-view-btn');
    var leftViewBtn = document.getElementById('left-view-btn');
    var rightViewBtn = document.getElementById('right-view-btn');	
	var wireframeBtn = document.getElementById('wireframe-btn');
    var cameraImage = document.getElementById('camera-image');

    if (!frontViewBtn || !backViewBtn || !leftViewBtn || !rightViewBtn ||!cameraImage || !wireframeBtn ) {
        return;
    }

    frontViewBtn.addEventListener('click', function() {
        cameraImage.src = "DR_FV.jpg";
        toggleImage();
    });

    backViewBtn.addEventListener('click', function() {
        cameraImage.src = "DR_BK.jpg";
        toggleImage();
    });

    leftViewBtn.addEventListener('click', function() {
        cameraImage.src = "DR_LFT.jpg";
        toggleImage();
    });
	
	rightViewBtn.addEventListener('click', function() {
        cameraImage.src = "DR_RGT.jpg";
        toggleImage();
    });
